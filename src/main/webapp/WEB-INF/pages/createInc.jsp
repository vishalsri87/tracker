<div class="panel panel-default">
	<div class="panel-heading">Create Incidents</div>
		...
		<form ng-submit="trController.submit()" name="myForm" class="form-horizontal" style="margin-left:50px; margin-top:20px">
			...
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
						<input type="text" ng-model="trController.inc.incNumber" id="incNumber"
				...
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
						<input type="text" ng-model="trController.inc.issue" id="issue"
							class="issue form-control input-sm"
							placeholder="Enter your issue" required ng-minlength="1" />
					</div>
				</div>
			</div>
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
						<input type="text" ng-model="trController.inc.description"
			...
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
						<input type="text" ng-model="trController.inc.resolution" id="resolution"
			...
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
					<select data-ng-options="o.name for o in trController.allSendBy" data-ng-model="trController.inc.sendBy" >
					<option value="" label="-- Select Send By --" disabled selected="selected">  Select Send By  </option>
					</select>
			...
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
					<select data-ng-options="o.name for o in trController.proirites" data-ng-model="trController.inc.priority">
					<option value="" label="-- Select Priority --" disabled selected="selected"> Priority  </option>
			...
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
						<select data-ng-options="o.name for o in trController.allStatus" data-ng-model="trController.inc.incStatus">
						<option value="" label="-- Select Status --" disabled selected="selected"> Select Status  </option>
			...
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
					<select data-ng-options="o.name for o in trController.allSolveBy" data-ng-model="trController.inc.solveBy">
					<option value="" label="-- Select SolveBy --" disabled selected="selected"> Select SolveBy  </option>
			...
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
						<input type="date" ng-model="trController.inc.issueDate" id="issueDate"
			...
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
						<input type="date" ng-model="trController.inc.pickByTcs" id="pickByTcs"
