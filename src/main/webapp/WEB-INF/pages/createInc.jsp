<div class="panel panel-default">
	...
	<div ng-controller="TrackerController as ctrl">
		...
		<form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal" style="margin-left:50px; margin-top:20px">
			...
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
						<input type="text" ng-model="ctrl.inc.description"
			...
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
					<select data-ng-options="o.name for o in ctrl.allSendBy" data-ng-model="ctrl.inc.sendBy" >
					<option value="" label="-- Select Send By --" disabled selected="selected">  Select Send By  </option>
					</select>
						<!-- <input type="text" ng-model="ctrl.inc.sendBy.id" id="sendBy"
							class="resolution form-control input-sm"
			...
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
					<select data-ng-options="o.name for o in ctrl.proirites" data-ng-model="ctrl.inc.priority">
					<option value="" label="-- Select Priority --" disabled selected="selected"> Priority  </option>
					
					</select>
					
					<!-- 
						<input type="text" ng-model="ctrl.inc.priority.id" id="sendBy"
			...
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
						<select data-ng-options="o.name for o in ctrl.allStatus" data-ng-model="ctrl.inc.incStatus">
						<option value="" label="-- Select Status --" disabled selected="selected"> Select Status  </option>
					
						</select>
					
						<!-- <input type="text" ng-model="ctrl.inc.incStatus.id" id="incStatus"
			...
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
					<select data-ng-options="o.name for o in ctrl.allSolveBy" data-ng-model="ctrl.inc.solveBy">
					<option value="" label="-- Select SolveBy --" disabled selected="selected"> Select SolveBy  </option>
					
					</select>
					
						<!-- <input type="text" ng-model="ctrl.inc.solveBy.id" id="solveBy"
				...
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
						<input type="date" ng-model="ctrl.inc.issueDate" id="issueDate"
							...
							value="{{ctrl.inc.issueDate | date : 'yyyy-MM-dd'}}" />
					</div>
				</div>
			</div>
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
						<input type="date" ng-model="ctrl.inc.pickByTcs" id="pickByTcs"
							...
							value="{{ctrl.inc.pickByTcs | date : 'yyyy-MM-dd'}}" />
					</div>
				</div>
			</div>
